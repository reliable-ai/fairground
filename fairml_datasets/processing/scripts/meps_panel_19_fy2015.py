...
class Script(LoadingScript, PreparationScript):
    ...
    def prepare(self, df: pd.DataFrame) -> pd.DataFrame:
        df = self.apply_AIF360_preprocessing_panel19_fy2015(df)

        return df

    # from: https://github.com/Trusted-AI/AIF360/blob/master/aif360/datasets/meps_dataset_panel19_fy2015.py
    def apply_AIF360_preprocessing_panel19_fy2015(self, df):
        """
